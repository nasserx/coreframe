...
// on the semantic ring token. Footer destinations retain their local
// foreground-to-muted-hover treatment; header navigation inherits the shared
// responsive SiteShellNavItem contract.
