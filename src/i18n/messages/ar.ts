...
export const ar: Messages = {
  ...
  marketing: {
    ...
    capabilitiesHeading: "إمكانات Coreframe",
    ...
    storyLead:
      "يحوّل Coreframe قراراته الجوهرية إلى نتائج قابلة للصيانة. لكل قدرة مالك واضح في الشفرة، وعقد موثَّق في موضعه، وفحص يناسب نوع المخاطر التي تقلّلها.",
    ...
    qualityLead:
      "يجمع Coreframe بين التحليل الساكن وفحوص المتصفح لأن أي طبقة منفردة لا تكشف كل أنواع الأعطال. تقلّل هذه الضوابط مخاطر معروفة وتجعل أدلتها قابلة للمراجعة، لكنها لا تدّعي أمانًا كاملًا.",
    ...
    faqTitle: "إجابات واضحة عن Coreframe.",
    faqLead: "يوضح Coreframe ما يقدّمه، وما يمكن تكييفه، وأين تنتهي ضماناته.",
    faqIncludedQuestion: "ماذا يتضمن Coreframe؟",
    faqIncludedAnswer:
    ...
    faqSecurityQuestion: "هل يضمن Coreframe انعدام الثغرات؟",
    faqSecurityAnswer:
  ...
  showcaseForm: {
    sectionTitle: "نموذج مرجعي لإعداد مشروع",
    sectionDescription:
      "التوصيل المرجعي: يملك React Hook Form حالة الحقول، ويملك مخطط Zod واحد عقدَ التحقق في الطرفين، وينقل apiFetch الإرسال إلى نقطة نهاية العرض في هذا المستودع. لا يُنشأ أي شيء — تتحقق نقطة النهاية من الحمولة وتعيد مرجعًا.",
    legend: "إعداد المشروع",
    projectNameLabel: "اسم المشروع",
    projectNameDescription: "من حرفين إلى 80 حرفًا. تُزال المسافات المحيطة.",
    ownerEmailLabel: "بريد المالك الإلكتروني",
    ownerEmailDescription: "يُقتطع ويُحوَّل إلى أحرف صغيرة قبل التحقق والإرسال.",
    goalLabel: "هدف التنفيذ",
    goalDescription: "من 20 إلى 500 حرف. استُخدم {count} من {max}.",
    submit: "إرسال المثال",
    submitPending: "جارٍ الإرسال",
    statusPending: "جارٍ إرسال المثال.",
    statusSuccess: "قُبل المثال — لم يُنشأ أي شيء. المرجع:",
    demoTitle: "قيم توضيحية محدَّدة النتيجة",
    demoFieldError: "يرفض الخادم حقل بريد المالك.",
    demoFormError: "يعيد الخادم خطأ خدمة على مستوى النموذج.",
    demoSuccess: "تُقبل أي حمولة صحيحة أخرى.",
    noteTitle: "كيف جرى التوصيل",
    noteState: "يملك React Hook Form حالة الحقول وحالة الإرسال والتركيز على أول حقل غير صالح.",
    noteValidation: "مخطط Zod واحد يتحقق في المتصفح ويحلّل الحمولة في الخادم.",
    noteTransport: "يرسل apiFetch الحمولة ويوحّد كل فشل في ApiError.",
    noteMapping: "تُربط أخطاء الحقول القادمة من الخادم بعناصرها، ويبقى خطأ النموذج منفصلًا.",
    errorProjectNameRequired: "أدخل اسم المشروع.",
    errorProjectNameShort: "استخدم حرفين على الأقل.",
    errorProjectNameLong: "استخدم 80 حرفًا كحد أقصى.",
    errorOwnerEmailRequired: "أدخل بريد المالك الإلكتروني.",
    errorOwnerEmailInvalid: "أدخل بريدًا إلكترونيًا صالحًا.",
    errorGoalRequired: "صِف هدف التنفيذ.",
    errorGoalShort: "استخدم 20 حرفًا على الأقل.",
    errorGoalLong: "استخدم 500 حرف كحد أقصى.",
    errorEmailTaken: "هذا البريد يخص مثالًا آخر بالفعل.",
    errorServiceUnavailable: "خدمة الأمثلة غير متاحة. حاول مرة أخرى.",
    errorUnexpected: "تعذّر إرسال المثال. حاول مرة أخرى.",
  },
};
