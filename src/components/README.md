...
Current contents: `ui/` holds the primitive library — shadcn/Base UI primitives adapted per `docs/UI_LIBRARY.md`, plus the layout set (Container, Stack, PageHeader, AppShell, SkipLink) documented in `docs/LAYOUT.md`.
